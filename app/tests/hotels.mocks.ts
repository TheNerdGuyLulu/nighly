export const hotelsMock: Nightly.Hotel[] = [
  {
    id: 12321,
...
export const hotelsOrderByDefaultDesc = [
  12330, 12329, 12328, 12327, 12326, 12325, 12324, 12323, 12322, 12321,
];

export const hotelsOrderByDefaultAsc = [
  12321, 12322, 12323, 12324, 12325, 12326, 12327, 12328, 12329, 12330,
];

export const hotelsOrderByPriceDesc = [
  12324,
  12327,
  12323,
  12325,
...
export const hotelsOrderByPriceAsc = [
  12330, 12326, 12322, 12329, 12321, 12328, 12323, 12325, 12327, 12324,
];

export const hotelsOrderByStarsAsc = [
  12324, 12327, 12323, 12321, 12329, 12322, 12330, 12325, 12328, 12326,
];

export const hotelsOrderByStarsDesc = [
  12325, 12328, 12326, 12327, 12323, 12321, 12329, 12322, 12330, 12324,
];

export const hotelsOrderByUserRatingAsc = [
  12324, 12330, 12325, 12322, 12323, 12326, 12327, 12328, 12329, 12321,
];

export const hotelsOrderByUserRatingDesc = [
  12321, 12328, 12329, 12326, 12327, 12323, 12322, 12325, 12330, 12324,
];
